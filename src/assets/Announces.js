...
const Announces = [
    {
        ...
        img: {
            jpg: {
                large: "images/carousel-images/jpg/banner-1-1024px.jpg",
            ...
            webp: {
                large: "images/carousel-images/webp/banner-1-1024px.webp",
    ...
    },
    {
        ...
        img: {
            jpg: {
                large: "images/carousel-images/jpg/banner-2-1024px.jpg",
            ...
            webp: {
                large: "images/carousel-images/webp/banner-2-1024px.webp",
