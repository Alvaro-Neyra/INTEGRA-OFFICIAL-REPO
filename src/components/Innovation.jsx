        ...
        <>
            <section className="innovation-section">
                ...
                <div className="innovation-text-container">
                    ...
                    <ButtonLink className="innovation-btn" route="/servicios" text="Ver Servicios" backgroundColor="rgb(100, 179, 244)" colorText="hsl(0, 0%, 100%)" backgroundHover="#6f7fc7" colorHover=""></ButtonLink>
                </div>
            </section>
        </>
    );
